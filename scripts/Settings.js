export const MODULE_NAME = "Foundry Campaign Stats";
export const MODULE_ID = "foundry-campaign-stats";

export const STORAGE_NAME = "foundry-campaign-stats-data";
export const STORAGE_NAME_CAMPAIGN_DATA =
  "do-not-delete-foundry-campaign-stats-data-campaign";
